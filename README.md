...
Key Results
Used over 44,000 articles to train a linear regression model with 99% accuracy
Identified 10 identifiers that are supported by the data we are using.
Methodologies
...
Nina Elmoyan (nelmoya509@student.glendale.edu)
Rhode Sanchez (rsanc266@fiu.edu)
Wynne Conger (wc2918@princeton.edu)
Ramneek Kaur(rnolas61@asu.edu)
